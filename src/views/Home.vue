  ...
  <div class="min-h-screen bg-gradient-to-br from-blue-50 to-blue-100 text-gray-800 font-sans">
    ...
    <section class="relative bg-gradient-to-r from-blue-600 to-blue-800 text-white py-24 overflow-hidden">
      <div class="absolute inset-0 opacity-10">
        <div class="absolute inset-0 bg-gradient-to-br from-white to-transparent opacity-20 animate-pulse"></div>
      </div>
      <div class="container mx-auto px-6 text-center relative z-10">
        <div class="max-w-4xl mx-auto">
          <h2 class="text-4xl md:text-5xl font-bold mb-6 leading-tight animate-fade-in">
            Your AI-Powered Exam Assistant for <span class="text-yellow-300 animate-pulse">Studying Smarter</span>
          </h2>
          <p class="text-xl md:text-2xl mb-8 text-blue-100 leading-relaxed animate-fade-in delay-100">
            ...
            <span class="font-semibold bg-blue-700/50 px-2 py-1 rounded-lg">Jibu AI helps you master exams with confidence.</span>
          </p>
          <div class="flex flex-col sm:flex-row justify-center gap-4 animate-fade-in delay-200">
            <router-link to="/uploadpaper">
              <button class="bg-yellow-400 hover:bg-yellow-300 text-blue-900 font-bold px-8 py-4 rounded-lg transition-all duration-300 hover:scale-105 shadow-lg hover:shadow-xl transform hover:-translate-y-1 active:scale-95">
                Try It Free Now
                <span class="ml-2 inline-block group-hover:animate-bounce">→</span>
              </button>
            </router-link>
            <button 
              onclick="window.open('https://www.youtube.com/shorts/GjXmWzPVqig', '_blank')" 
              class="bg-transparent border-2 border-white text-white font-semibold px-8 py-4 rounded-lg hover:bg-white hover:text-blue-800 transition-all duration-300 hover:scale-105 transform hover:-translate-y-1 active:scale-95 flex items-center justify-center">
              Watch Demo Video
    ...
    <section class="py-12 bg-white">
      <div class="container mx-auto px-6">
        <p class="text-center text-gray-500 mb-8">Trusted by Students Across Kenya For:</p>
        <div class="flex flex-wrap justify-center items-center gap-4 md:gap-8 opacity-80">
          <div class="w-auto px-6 py-3 bg-blue-50 rounded-full flex items-center justify-center hover:bg-blue-100 transition-colors duration-300">
            <span class="font-bold text-blue-700">School Practicals</span>
          </div>
          <div class="w-auto px-6 py-3 bg-blue-50 rounded-full flex items-center justify-center hover:bg-blue-100 transition-colors duration-300">
            <span class="font-bold text-blue-700">Exam Revision</span>
          </div>
          <div class="w-auto px-6 py-3 bg-blue-50 rounded-full flex items-center justify-center hover:bg-blue-100 transition-colors duration-300">
            <span class="font-bold text-blue-700">Quick Quizzes</span>
          </div>
          <div class="w-auto px-6 py-3 bg-blue-50 rounded-full flex items-center justify-center hover:bg-blue-100 transition-colors duration-300">
            <span class="font-bold text-blue-700">Topic Summaries</span>
          </div>
          <div class="w-auto px-6 py-3 bg-blue-50 rounded-full flex items-center justify-center hover:bg-blue-100 transition-colors duration-300">
            <span class="font-bold text-blue-700">Lesson Management</span>
          </div>
        </div>
      </div>
    </section>

    <!-- Upload Feature Section with card -->
    <section id="how-it-works" class="py-20 bg-gradient-to-b from-white to-blue-50">
      <div class="container mx-auto px-6">
        <div class="text-center mb-16">
          <h3 class="text-3xl font-bold mb-4">How Jibu AI Works</h3>
          <p class="text-xl text-gray-600 max-w-3xl mx-auto">Transform your study sessions in just three simple steps</p>
        </div>
        
        <div class="grid md:grid-cols-3 gap-8 mb-16">
          <div class="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2 border-b-4 border-blue-100">
            <div class="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center mb-6 mx-auto shadow-inner">
          ...
          <div class="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2 border-b-4 border-blue-100">
            ...
            <h4 class="text-xl font-bold mb-4 text-center">AI Processes Content</h4>
            <p class="text-gray-600 text-center">Our advanced AI analyzes and understands the questions</p>
            <div class="mt-4 flex justify-center">
          ...
          <div class="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2 border-b-4 border-blue-100">
            ...
            <h4 class="text-xl font-bold mb-4 text-center">Get Solutions</h4>
            <p class="text-gray-600 text-center">Receive detailed, step-by-step solutions in your preferred language</p>
            <div class="mt-4 flex justify-center">
        ...
        <div class="max-w-4xl mx-auto bg-white rounded-xl shadow-2xl overflow-hidden transform hover:scale-[1.01] transition-transform duration-300">
          <div class="md:flex">
            <div class="md:w-1/2 bg-blue-700 p-8 text-white flex flex-col justify-center relative overflow-hidden">
              <div class="absolute inset-0 bg-gradient-to-br from-white/10 to-transparent opacity-20"></div>
              <div class="relative z-10">
                ...
                <div class="flex flex-col space-y-4">
                  <router-link to="/uploadpaper" class="flex flex-col space-y-">
                    <button class="bg-white text-blue-700 font-semibold px-6 py-3 rounded-lg hover:bg-blue-100 transition-all transform hover:-translate-y-0.5 active:scale-95">
                      Upload Paper
                    </button>
                  </router-link>
                  <button class="border border-white text-white font-semibold px-6 py-3 rounded-lg hover:bg-blue-600 transition-all transform hover:-translate-y-0.5 active:scale-95">
            ...
            <div class="md:w-1/2 p-8">
              <div class="border-2 border-dashed border-blue-300 rounded-lg p-6 text-center h-full flex flex-col items-center justify-center bg-blue-50/50 hover:bg-blue-100/30 transition-colors duration-300">
                ...
                <div class="relative mb-4">
                  ...
                  <div class="absolute -bottom-1 -right-1 w-6 h-6 rounded-full bg-blue-600 flex items-center justify-center">
                ...
                <div class="w-full h-48 bg-gray-100 mb-4 flex items-center justify-center rounded-lg overflow-hidden relative border-2 border-gray-200">
                  <div class="absolute inset-0 flex items-center justify-center">
                    <div class="border-2 border-blue-400 border-dashed w-3/4 h-3/4 rounded-lg flex items-center justify-center">
                ...
                <router-link to="/uploadpaper">
                  <button class="bg-blue-600 text-white px-6 py-2 rounded-lg hover:bg-blue-700 transition-colors transform hover:-translate-y-0.5 active:scale-95 flex items-center">
                    Capture Scan
    ...
    <section id="features" class="py-20 bg-blue-600 text-white">
      <div class="container mx-auto px-6">
        <div class="text-center mb-16">
          <h3 class="text-3xl font-bold mb-4">Why Jibu AI Stands Out</h3>
          <p class="text-xl text-blue-100 max-w-3xl mx-auto">More than just answers - a complete learning companion</p>
        </div>
        ...
        <div class="max-w-5xl mx-auto">
          <div class="flex flex-wrap justify-center mb-8 gap-2">
            <button 
              ...
              :class="{
                'bg-white text-blue-700 shadow-lg': activeTab === index, 
                'text-blue-100 hover:text-white hover:bg-blue-700/50': activeTab !== index
              }"
              class="px-6 py-3 rounded-lg font-medium transition-all duration-300 transform hover:-translate-y-0.5"
            >
              {{ tab.title }}
            </button>
          </div>
          
          <div class="bg-white rounded-lg shadow-2xl overflow-hidden transform transition-all duration-500 hover:shadow-xl">
            <div class="md:flex">
              <div class="md:w-1/2 p-8 md:p-12">
                <h4 class="text-2xl font-bold text-gray-800 mb-4">{{ tabs[activeTab].title }}</h4>
                <p class="text-gray-600 mb-6">{{ tabs[activeTab].description }}</p>
                <ul class="space-y-3">
                  <li v-for="(feature, i) in tabs[activeTab].features" :key="i" class="flex items-start animate-fade-in-right" :style="`animation-delay: ${index * 0.1 + 0.2}s`">
              ...
              <div class="md:w-1/2 bg-gray-50 p-8 flex items-center justify-center relative">
                <img 
                  ...
                  class="rounded-lg shadow-md w-full h-auto max-h-80 object-contain transition-transform duration-500 hover:scale-105"
                >
                <div class="absolute bottom-4 right-4 bg-white/90 backdrop-blur-sm px-3 py-1 rounded-full shadow-sm text-xs font-medium text-gray-800">
                  Try it now!
                </div>
              </div>
            </div>
      ...
      <div class="container mx-auto px-6">
        <div class="text-center mb-16">
          ...
          <p class="text-xl text-gray-600 max-w-3xl mx-auto">
            Discover powerful features designed to optimize your study sessions, boost retention, and maximize academic performance.
          </p>
        </div>
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <router-link to="/aistudy">
            <div
              ...
              class="bg-blue-50 rounded-xl p-6 transition-all duration-300 hover:shadow-xl hover:-translate-y-2 cursor-pointer border-l-4 border-blue-400"
              :class="{'ring-2 ring-blue-500': hoveredFeature === 1}"
            >
              <div class="flex items-center mb-4">
                <div class="w-12 h-12 bg-blue-100 rounded-lg flex items-center justify-center mr-4 shadow-inner">
          ...
          <router-link to="/aispeech">
            <div
              ...
              @mouseleave="hoveredFeature = null"
              class="bg-purple-50 rounded-xl p-6 transition-all duration-300 hover:shadow-xl hover:-translate-y-2 cursor-pointer border-l-4 border-purple-400"
              :class="{'ring-2 ring-purple-500': hoveredFeature === 4}"
            >
              <div class="flex items-center mb-4">
                <div class="w-12 h-12 bg-purple-100 rounded-lg flex items-center justify-center mr-4 shadow-inner">
                  <span class="text-2xl">🗣️</span>
                </div>
          ...
          <router-link to="/quizai">
            <div
              class="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 border-l-4 border-yellow-400"
            ...
            >
              <div class="h-48 bg-gradient-to-br from-blue-100 to-indigo-100 flex items-center justify-center relative">
                ...
                <div class="absolute top-4 right-4 trophy-icon bg-yellow-100 text-yellow-600 p-2 rounded-full shadow-sm animate-bounce">
                  🏆
                </div>
              ...
              <div class="p-6">
                ...
                <div class="flex flex-wrap gap-2">
                  <span class="feature-tag bg-blue-100 text-blue-800">Daily Challenges</span>
                  <span class="feature-tag bg-blue-100 text-blue-800">Leaderboards</span>
                  <span class="feature-tag bg-blue-100 text-blue-800">Airtime Rewards</span>
                </div>
              </div>
            </div>
          </router-link>
          ...
          <router-link to="/tutor">
            <div
              class="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 border-l-4 border-indigo-400"
              ...
              <div class="h-48 bg-gradient-to-br from-indigo-100 to-blue-100 flex items-center justify-center">
                <div class="ai-tutor-visual flex flex-col items-center">
                  <div class="relative mb-2">
                    <div class="w-20 h-20 rounded-full bg-indigo-200 flex items-center justify-center shadow-inner">
                      <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10 text-indigo-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" />
                      </svg>
                    </div>
                    <div class="absolute -bottom-1 -right-1 w-6 h-6 rounded-full bg-green-500 border-2 border-white flex items-center justify-center animate-pulse">
    ...
    <section id="testimonials" class="py-20 bg-white">
      <div class="container mx-auto px-6">
        <div class="text-center mb-16">
          <h3 class="text-3xl font-bold mb-4">What Students Say</h3>
          <p class="text-xl text-gray-600 max-w-3xl mx-auto">Hear from students who improved their grades with Jibu AI</p>
        </div>
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div 
            ...
            :key="index"
            class="bg-blue-50 rounded-xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2"
          >
            <div class="flex items-center mb-6">
              <div class="w-12 h-12 rounded-full bg-blue-200 flex items-center justify-center text-blue-800 font-bold mr-4 shadow-inner">
            ...
            <div class="flex">
              <span v-for="star in 5" :key="star" class="text-yellow-400">
                <svg class="w-5 h-5" :class="{'text-gray-300': star > testimonial.rating}" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
    ...
    <section id="pricing" class="py-20 bg-blue-50">
      <div class="container mx-auto px-6">
        <div class="text-center mb-16">
          <h3 class="text-3xl font-bold mb-4">Simple, Affordable Pricing</h3>
          <p class="text-xl text-gray-600 max-w-3xl mx-auto">Choose the plan that fits your study needs</p>
        </div>
        ...
        <div class="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          <div class="bg-white rounded-xl shadow-lg overflow-hidden transform hover:scale-[1.02] transition-transform duration-300">
            <div class="p-8 text-center">
              ...
              <router-link to="/BasicPackage">
                <button class="w-full bg-blue-100 text-blue-700 font-semibold px-6 py-3 rounded-lg hover:bg-blue-200 transition-colors transform hover:-translate-y-0.5">
                  Get Started
                </button>
              </router-link>
            </div>
            <div class="border-t border-gray-200 p-8 bg-gray-50">
              <ul class="space-y-3">
                <li class="flex items-center">
                  ...
                  <span>10 paper uploads/month</span>
                </li>
                <li class="flex items-center">
                  <svg class="w-5 h-5 text-green-500 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                  </svg>
                  <span>Swahili or English</span>
                </li>
                <li class="flex items-center text-gray-400">
                  ...
                  <span>No voice assistance</span>
                </li>
              </ul>
            </div>
          </div>
          
          <div class="bg-white rounded-xl shadow-xl overflow-hidden transform scale-105 border-2 border-yellow-300 hover:scale-[1.07] transition-transform duration-300">
            ...
            <div class="p-8 text-center">
              ...
              <router-link to="/PremiumPackage">
                <button class="w-full bg-yellow-400 text-blue-900 font-bold px-6 py-3 rounded-lg hover:bg-yellow-300 transition-colors shadow-md transform hover:-translate-y-0.5">
                  Get Started
                </button>
              </router-link>
            </div>
        ...
        <div class="mt-12 text-center">
          <p class="text-gray-600">Not sure which plan is right for you? <a href="#" class="text-blue-600 font-semibold hover:underline">Contact our team</a></p>
        </div>
      </div>
    </section>
    ...
    <section class="py-20 bg-gradient-to-r from-blue-700 to-blue-900 text-white">
      <div class="container mx-auto px-6 text-center">
        <div class="max-w-4xl mx-auto">
          <h3 class="text-3xl md:text-4xl font-bold mb-6">Ready to Transform Your Study Experience?</h3>
          <p class="text-xl text-blue-100 mb-8">Join thousands of Kenyan students who are studying smarter with Jibu AI</p>
          <div class="flex flex-col sm:flex-row justify-center gap-4">
            <button class="bg-yellow-400 hover:bg-yellow-300 text-blue-900 font-bold px-8 py-4 rounded-lg transition-all duration-300 hover:scale-105 shadow-lg hover:shadow-xl transform hover:-translate-y-1 active:scale-95">
              Start Free 7-Day Trial
            </button>
            <button class="bg-transparent border-2 border-white text-white font-semibold px-8 py-4 rounded-lg hover:bg-white hover:text-blue-800 transition-all duration-300 hover:scale-105 transform hover:-translate-y-1 active:scale-95">
              Talk to Our Experts
            </button>
          </div>
        </div>
    ...
    <section class="py-20 bg-white">
      <div class="container mx-auto px-6">
        <div class="text-center mb-16">
          <h3 class="text-3xl font-bold mb-4">Frequently Asked Questions</h3>
          <p class="text-xl text-gray-600 max-w-3xl mx-auto">Everything you need to know about Jibu AI</p>
        </div>
        ...
        <div class="max-w-3xl mx-auto">
          <div 
            ...
            :key="index"
            class="mb-4 border border-gray-200 rounded-lg overflow-hidden transition-all duration-300 hover:shadow-md"
          >
            <button 
              @click="toggleFAQ(index)"
              class="w-full flex justify-between items-center p-6 text-left bg-blue-50 hover:bg-blue-100 transition-colors"
            >
              <h4 class="font-bold text-lg text-gray-800">{{ faq.question }}</h4>
              <svg 
            ...
            <div 
              ...
              class="p-6 pt-0 text-gray-600 transition-all duration-300"
            >
              <p>{{ faq.answer }}</p>
            </div>
          </div>
    ...
    <footer class="bg-blue-900 text-white pt-16 pb-8">
      <div class="container mx-auto px-6">
        <div class="grid md:grid-cols-4 gap-12 mb-12">
          <div>
            <div class="flex items-center space-x-2 mb-4">
              <svg class="w-8 h-8 text-blue-300" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
          ...
          <div>
            ...
            <ul class="space-y-2">
              ...
              <li><a href="#" class="text-blue-200 hover:text-white transition-colors">Examples</a></li>
              <li><a href="#" class="text-blue-200 hover:text-white transition-colors">Updates</a></li>
            </ul>
          </div>
        ...
        <div class="border-t border-blue-800 pt-8 text-center text-blue-300">
...
const tabs = [
  {
    ...
    description: "Learn in the language you're most comfortable with for better understanding.",
    features: [
      "Switch between Swahili and English instantly",
      "Cultural context included in explanations",
      "Perfect for all Kenyan students",
      "Specialized education terminology"
    ],
    image: "https://images.unsplash.com/photo-1522202176988-66273c2fd55f?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60"
  },
  {
    title: "Voice Assistance",
    description: "Study hands-free with our voice-enabled learning features.",
    features: [
      "Hear solutions read out loud",
...
const faqs = [
  ...
  },
  {
    ...
    answer: "Our AI has been trained on thousands of past papers and verified by education experts. While we strive for 100% accuracy, we recommend consulting your teachers for final verification of complex problems."
  },
  {
    question: "Can I use Jibu AI without internet?",
    answer: "Currently, Jibu AI requires an internet connection to process your uploads and provide solutions. However, once solutions are generated, you can download them for offline access."
  },
  {
    question: "Is there a free trial available?",
    answer: "Yes! We offer a 7-day free trial for our Premium plan with no credit card required. You can cancel anytime during the trial period."
  },
  {
