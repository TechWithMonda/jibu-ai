...
<NavBar/> 
  ...
  <button 
    @click="printResults"
    class="flex-1 bg-white border border-gray-300 text-gray-800 py-3 px-4 rounded-lg hover:bg-gray-50 transition-colors flex items-center justify-center"
  >
    <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  const printContent = `
    ...
    <head>
      ...
      <style>
        ...
        .model-info { background: #ebf8ff; padding: 10px; border-radius: 5px; margin-bottom: 20px; }
    ...
    <body>
      ...
      <div class="model-info">
        ...
        <p><strong>Model Used:</strong> ${this.selectedModel.charAt(0).toUpperCase() + this.selectedModel.slice(1)}</p>
        <p><strong>Processing Time:</strong> ${this.processingTime} seconds</p>
      ...
      <div class="no-print" style="margin-top: 30px; font-size: 0.8em; color: #718096;">
        <p>Generated by AI-Powered Exam Solutions</p>
      </div>
    </body>
    </html>
  `;
